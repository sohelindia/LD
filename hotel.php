            ...
            <div class="col-auto">
              <div class="row x-gap-15 y-gap-15 items-center">
                <div class="col-auto">
                  <div class="text-14">
                    From
                    <span class="text-22 text-dark-1 fw-500">₹50972</span>
                  </div>
                </div>
      ...
      <div class="container">
        ...
        <div class="galleryGrid -type-1 pt-30">
          <div class="galleryGrid__item relative d-flex">
            <img src="/assets/img/gallery/1/1.png" alt="image" class="rounded-4">
          ...
          <div class="galleryGrid__item">
            <img src="/assets/img/gallery/1/2.png" alt="image" class="rounded-4">
          </div>

          <div class="galleryGrid__item relative d-flex">
            <img src="/assets/img/gallery/1/3.png" alt="image" class="rounded-4">
          ...
          <div class="galleryGrid__item">
            <img src="/assets/img/gallery/1/4.png" alt="image" class="rounded-4">
          </div>

          <div class="galleryGrid__item relative d-flex">
            <img src="/assets/img/gallery/1/5.png" alt="image" class="rounded-4">
            ...
            <div class="ml-50 lg:ml-0">
              <div class="px-30 py-30 border-light rounded-4 shadow-4">
                <div class="d-flex items-center justify-between">
                  <div class="">
                    <span class="text-20 fw-500">₹50972</span>
                ...
                <div class="roomGrid__grid">
                  ...
                  <div class="y-gap-30">
                    ...
                    <div class="roomGrid__content">
                      ...
                      <div>
                        <div class="text-18 lh-15 fw-500">₹50972</div>
                      ...
                      <div>
                        ...
                        <div class="dropdown js-dropdown js-price-1-active">
                          <div class="dropdown__button d-flex items-center rounded-4 border-light px-15 h-50 text-14" data-el-toggle=".js-price-1-toggle" data-el-toggle-active=".js-price-1-active">
                            <span class="js-dropdown-title">1 (₹509 3,120)</span>
                          ...
                          <div class="toggle-element -dropdown  js-click-dropdown js-price-1-toggle">
                            <div class="text-14 y-gap-15 js-dropdown-list">
                              ...
                              <div><a href="#" class="d-block js-dropdown-link">2 (₹509 3,120)</a></div>

                              <div><a href="#" class="d-block js-dropdown-link">3 (₹509 3,120)</a></div>

                              <div><a href="#" class="d-block js-dropdown-link">4 (₹509 3,120)</a></div>

                              <div><a href="#" class="d-block js-dropdown-link">5 (₹509 3,120)</a></div>
                  ...
                  <div>
                    ...
                    <div class="text-22 fw-500 lh-17 mt-5">₹50972</div>
      ...
      <div class="container">
        <div class="row y-gap-60">
          ...
          <div class="col-lg-6">
            <div class="row x-gap-20 y-gap-20 items-center">
              <div class="col-auto">
                <img src="/assets/img/avatars/2.png" alt="image">
              </div>
              <div class="col-auto">
            ...
            <div class="row x-gap-30 y-gap-30 pt-20">
              ...
              <div class="col-auto">
                <img src="/assets/img/testimonials/1/1.png" alt="image" class="rounded-4">
              </div>

              <div class="col-auto">
                <img src="/assets/img/testimonials/1/2.png" alt="image" class="rounded-4">
              </div>

              <div class="col-auto">
                <img src="/assets/img/testimonials/1/3.png" alt="image" class="rounded-4">
              </div>

              <div class="col-auto">
                <img src="/assets/img/testimonials/1/4.png" alt="image" class="rounded-4">
              </div>
          ...
          <div class="col-xl-3 col-lg-3 col-sm-6">
            ...
            <a href="hotel-single-1.html" class="hotelsCard -type-1 ">
              ...
              <div class="hotelsCard__content mt-10">
                ...
                <div class="mt-5">
                  <div class="fw-500">
                    Starting from <span class="text-blue-1">₹50972</span>
                  </div>
                </div>
              </div>
            </a>
